    ...
    <div className="min-h-screen p-12">
      ...
      <section className="mb-16">
        ...
        <div className="flex gap-6 overflow-x-auto pb-4 hide-scrollbar">
          {[
            { type: "Textbook", typeBg: "bg-tertiary-container text-on-tertiary-container", title: "Principles of Neural Design", author: "Sterling & Laughlin • 2021", progress: "Page 142/480", progressW: "65%", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCOPjirJSPJ4aifofM6qdz6VSYl1RcQooTrsQwkbZAjrEKWKWswlkXEH0n4eM8WbvfzMn-enHY0rJX1O_HDHRH20mXmlmlQj3DwJecTEOSr0AO8fLKtg9porZT_aAZIW6oIXh33SSSoLkdFmEsVNVdQBqGFSXJwQlDypMP4DUkSSpDGHbYX2BFdhMa0CA7ppu4z2MNDBf1mzmSrDkgHaUfqcH8iozkFBnZlwGOhvGjYm842BrwVYYx6VApSQ8ou28m1j1pNyPzbWysq" },
            { type: "Journal", typeBg: "bg-primary-container text-on-primary-container", title: "Quantum Computing Ethics", author: "MIT Technology Review • Vol 14", progress: "Read 2h ago", progressW: null, img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDeeUhpyHPm_T9i8c55WuQ2WaHNB0iV3D9eaunNPEwfi9-t46EKIKHSh4YPRfT3SB-y285DxYvlLuFiwEDpA-iGUxjjl9jdthFCpmPZaEul2o5UyGXg6m7Pc7k89sQ7VxHs8CiuJyJFvPOT-GUVLGQgjxd_WPqIvlQfT13RakEPUVyE95QZv10X66Ov5P6e5cpk8AoE1XI4GSLXQgDilbncSDyHUQDDt-cz8hWxR3z-MH5yqWEAUWk2ayXzY7eLOm5SIozAuTg9Ivjk" },
            { type: "Video", typeBg: "bg-secondary-container text-on-secondary-container", title: "Advanced Algorithm Design", author: "Dr. Sarah Jenkins • Stanford", progress: "14:02 / 35:00", progressW: "40%", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCmuiIE9TP9TiUUNPUwTdBp_z4tClOj-6zwFXEqjOZIDOEntTXUyjJhqaRrv0Dnba4E7lYLHaVeSn2Xwh_okFaMUj4tkekeyyxk1iy6miNu0cE_6nm_BXu_nzY_V6wIhf78x6bMwBMBkgz3_bHveYC8mdy3zC1e144WYTVaudsaF-XKsp6XseH1PCRIDX06x_BZUuC8YqGZQVaLXn6KCjTWcBun2A6IKBtbmh8yyCK4WBKgODk75V7ASj6ayArn-LiqTElgu53aiimS", isVideo: true },
          ].map((item) => (
            <div key={item.title} className="min-w-[320px] bg-surface-container-lowest p-6 rounded-3xl relative group cursor-pointer hover:bg-surface-bright transition-all">
              ...
              <h3 className="font-manrope font-bold text-on-surface mb-1">{item.title}</h3>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-8 bg-surface-container-lowest p-8 rounded-3xl flex items-center gap-8 relative overflow-hidden group cursor-pointer border border-transparent hover:border-primary/10 transition-all">
            <div className="relative z-10 w-1/2">
              ...
              <button className="px-6 py-2 bg-on-surface text-surface rounded-full text-xs font-bold hover:bg-primary transition-colors">Explore Collection</button>
            </div>
          ...
          <div className="col-span-4 bg-tertiary-container p-8 rounded-3xl flex flex-col justify-between relative overflow-hidden group cursor-pointer transition-all">
          ...
          <div className="col-span-4 bg-surface-container-low p-8 rounded-3xl flex flex-col justify-between group cursor-pointer hover:bg-surface-container-high transition-all">
            <div>
          ...
          <div className="col-span-8 bg-surface-container-lowest p-8 rounded-3xl flex justify-between relative overflow-hidden group cursor-pointer border border-transparent hover:border-primary/10 transition-all">
            <div className="w-2/3">
      ...
      <section>
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-2">
            <button className="px-4 py-2 text-xs font-bold text-primary bg-primary-container rounded-full">All Resources</button>
            <button className="px-4 py-2 text-xs font-bold text-on-surface-variant hover:bg-surface-container rounded-full transition-colors">Saved</button>
            <button className="px-4 py-2 text-xs font-bold text-on-surface-variant hover:bg-surface-container rounded-full transition-colors">By Department</button>
          </div>
        </div>
        <div className="bg-surface-container-lowest rounded-3xl overflow-hidden shadow-sm">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-surface-container">
              {[
                { icon: "picture_as_pdf", title: "Computational Fluid Dynamics", author: "Dr. Alan Turing • 12MB", cat: "Engineering", catBg: "bg-surface-container", catColor: "text-on-surface-variant", date: "Oct 12, 2023", action: "download" },
                { icon: "description", title: "The Future of AI Governance", author: "Global Policy Review • 4MB", cat: "Political Science", catBg: "bg-tertiary-container", catColor: "text-on-tertiary-container", date: "Nov 02, 2023", action: "bookmark" },
                { icon: "movie", title: "Linear Algebra - Session 1", author: "MIT OpenCourseWare • 1.2GB", cat: "Mathematics", catBg: "bg-secondary-container", catColor: "text-on-secondary-container", date: "Sep 28, 2023", action: "play_circle" },
              ].map((item) => (
                <tr key={item.title} className="hover:bg-surface-bright transition-colors group">
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-3">
                      <span className="material-symbols-outlined text-on-surface-variant">{item.icon}</span>
                      <div>
                        <p className="text-sm font-bold font-manrope">{item.title}</p>
